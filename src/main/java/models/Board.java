...
/* === ON CELL MOUSE DOWN EVENT HANDLER ========================================================= */
  ...
  public void setPieces() {
    ...
    pieces[7]  = new Rook((byte)0, Colour.BLACKS, (byte)7, (byte)1);
    pieces[24] = new Rook((byte)0, Colour.WHITES, (byte)0, (byte)7);
    ...
    pieces[31] = new Rook((byte)0, Colour.WHITES, (byte)7, (byte)7);
